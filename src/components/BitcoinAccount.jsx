...
const BitcoinAccount = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <button onClick={handleTransferClick} className='hover:shadow-2xl hover:bg-blue-900 text-center items-center flex flex-row text-white bg-[#0f1b39] space-x-[40px] md:space-x-[150px] rounded-lg p-8 border-2'>
